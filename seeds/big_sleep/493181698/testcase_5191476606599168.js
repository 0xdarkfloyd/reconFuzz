...
// Flags: --allow-natives-syntax --turboshaft-wasm-in-js-inlining --turbolev-inline-js-wasm-wrappers --no-turbolev

d8.file.execute("wasm-module-builder.js");

const builder = new WasmModuleBuilder();
builder.addFunction("wasm_func", kSig_i_v)
  .addBody([kExprI32Const, 42])
  .exportFunc();
const instance = builder.instantiate();
const wasm_func = instance.exports.wasm_func;
